...
public class DaftarMakananActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomAdapter customAdapter = new CustomAdapter(DaftarMakananActivity.this, db.getAllNIM(), db.getAllNama(), db.getAllJurusan());
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DaftarMakananActivity.this, Pesan.class));
            }
        });
    }
