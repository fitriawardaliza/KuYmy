...
public class UpdatePesanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DataPesanan(UpdatePesanan.this);
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db.open();
                db.updatePesanan(editTextNIM.getText().toString(), editTextNama.getText().toString(), editTextJurusan.getText().toString());
                Toast.makeText(UpdatePesanan.this, "Data updated!", Toast.LENGTH_LONG).show();
                db.close();
                Intent intent = new Intent(UpdatePesanan.this, DaftarMakananActivity.class);
        ...
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.requestPermissions(UpdatePesanan.this, new String[] {Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_CODE_GALLERY);
            }
        });
    }
